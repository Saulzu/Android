...
public class MainActivity3 extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {

    String sClave, sTitulo, sAutor;
    EditText etClave, etTitulo, etAutor;
    Button bQuitar, bRegresa;
    ...
    public void onClick(View view) {
        ...
        if(cadenita.equals("Buscar")){
            ...
            baselite.execSQL("DELETE FROM mus WHERE clave = '" + sClave + "'");
            baselite.close();

            Toast.makeText(this,"Musica eliminada",Toast.LENGTH_LONG).show();
            resetea();
        }
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
        if (adapterView.getId() == R.id.brcombito) {
